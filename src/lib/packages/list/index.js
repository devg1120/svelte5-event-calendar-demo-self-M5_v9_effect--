...
function create_fragment$3(ctx) {
    ...
    return {
                ...
                dispose = [
                    ...
                    listen(article, "keydown", function () {
                        if (is_function(/*onclick*/ ctx[5] && keyEnter(/*onclick*/ ctx[5])))
                            /*onclick*/ (ctx[5] && keyEnter(/*onclick*/ ctx[5])).apply(this, arguments);
                    }),
                    listen(article, "mouseenter", function () {
                        if (is_function(/*createHandler*/ ctx[25](/*$eventMouseEnter*/ ctx[6])))
                            /*createHandler*/ ctx[25](/*$eventMouseEnter*/ ctx[6]).apply(this, arguments);
                    }),
                    listen(article, "mouseleave", function () {
                        if (is_function(/*createHandler*/ ctx[25](/*$eventMouseLeave*/ ctx[7])))
                            /*createHandler*/ ctx[25](/*$eventMouseLeave*/ ctx[7]).apply(this, arguments);
                    }),
        ...
        p(new_ctx, dirty) {
            ...
            if (setContent_action && is_function(setContent_action.update) && dirty[0] & /*content*/ 16)
            ...
            if (
                dirty[0] & /*onclick*/ 32 &&
                article_role_value !== (article_role_value = /*onclick*/ ctx[5] ? "button" : undefined)
            ) {
            ...
            if (
                dirty[0] & /*onclick*/ 32 &&
                article_tabindex_value !== (article_tabindex_value = /*onclick*/ ctx[5] ? 0 : undefined)
            ) {
...
function instance$2($$self, $$props, $$invalidate) {
    ...
    $$self.$$.update = () => {
        ...
        if (
            ($$self.$$.dirty[0] & /*chunk, $theme, $_intlEventTime, $_view*/ 1677721601) |
...
function create_if_block$1(ctx) {
    ...
    return {
        ...
        p(new_ctx, dirty) {
            ...
            if (setContent_action && is_function(setContent_action.update) && dirty & /*$_intlListDay, date*/ 257)
                setContent_action.update.call(null, /*$_intlListDay*/ ctx[8].format(/*date*/ ctx[0]));

            if (
                !current ||
                (dirty & /*$theme*/ 64 && time1_class_value !== (time1_class_value = /*$theme*/ ctx[6].daySide))
            ) {
            ...
            if (
                ...
                setContent_action_1.update.call(null, /*$_intlListDaySide*/ ctx[9].format(/*date*/ ctx[0]));

            if (
                !current ||
                (dirty & /*$theme*/ 64 && h4_class_value !== (h4_class_value = /*$theme*/ ctx[6].dayHead))
            ) {
...
function create_if_block(ctx) {
    ...
    return {
        ...
        p(ctx, dirty) {
            ...
            if (setContent_action && is_function(setContent_action.update) && dirty & /*content*/ 1)
...
function create_fragment$1(ctx) {
    ...
    return {
        ...
        p(ctx, [dirty]) {
            ...
            if (
                !current ||
                (dirty & /*$theme*/ 8 && div1_class_value !== (div1_class_value = /*$theme*/ ctx[3].body))
            ) {
                attr(div1, "class", div1_class_value);
            }
        },
...
function instance($$self, $$props, $$invalidate) {
    ...
    $$self.$$.update = () => {
        ...
        if ($$self.$$.dirty & /*$noEventsContent, content*/ 8193) {
            {
                $$invalidate(0, (content = isFunction($noEventsContent) ? $noEventsContent() : $noEventsContent));

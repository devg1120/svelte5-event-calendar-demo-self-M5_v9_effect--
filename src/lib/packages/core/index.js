        ...
        c() {
            ...
            attr(
                ...
                (button_1_class_value =
                    "" +
                    /*$theme*/ (ctx[5].button +
                        /*$view*/ (ctx[9] === /*button*/ ctx[34] ? " " + /*$theme*/ ctx[5].active : "") +
                        " ec-" +
                        /*button*/ ctx[34])),
            );
        },
    ...
    return {
            ...
            attr(
                ...
                (button_1_class_value =
                    ...
                    /*$theme*/ (ctx[5].button +
                        " ec-" +
                        /*button*/ ctx[34] +
                        /*$customButtons*/ (ctx[8][/*button*/ ctx[34]].active ? " " + /*$theme*/ ctx[5].active : ""))),
            );
        },
        m(target, anchor) {
            insert(target, button_1, anchor);
            ...
            if (!mounted) {
                dispose = [
                    listen$1(button_1, "click", function () {
                        if (is_function(/*$customButtons*/ ctx[8][/*button*/ ctx[34]].click))
                            /*$customButtons*/ ctx[8][/*button*/ ctx[34]].click.apply(this, arguments);
                    }),
                    action_destroyer(
        ...
        p(new_ctx, dirty) {
            ...
            if (
                ...
                setContent_action.update.call(null, /*$customButtons*/ ctx[8][/*button*/ ctx[34]].text);
        },
        d(detaching) {
            if (detaching) {
                detach(button_1);
    ...
    return {
        c() {
            ...
            attr(
                button_1,
                "class",
                (button_1_class_value = "" + /*$theme*/ (ctx[5].button + " ec-" + /*button*/ ctx[34])),
            );
...
function create_if_block_2(ctx) {
    ...
    return {
        ...
        p(ctx, dirty) {
            if (
                dirty[0] & /*$theme, buttons*/ 33 &&
                i_class_value !== (i_class_value = "" + /*$theme*/ (ctx[5].icon + " ec-" + /*button*/ ctx[34]))
            ) {
            ...
            if (
                ...
                button_1_aria_label_value !== (button_1_aria_label_value = /*$buttonText*/ ctx[7].next)
            ) {
            ...
            if (
                dirty[0] & /*$buttonText*/ 128 &&
                button_1_title_value !== (button_1_title_value = /*$buttonText*/ ctx[7].next)
            ) {
...
function create_if_block_1(ctx) {
    ...
    return {
        ...
        p(ctx, dirty) {
            ...
            if (
                dirty[0] & /*$buttonText*/ 128 &&
                button_1_aria_label_value !== (button_1_aria_label_value = /*$buttonText*/ ctx[7].prev)
            ) {
                attr(button_1, "aria-label", button_1_aria_label_value);
            }
            ...
            if (
                dirty[0] & /*$buttonText*/ 128 &&
                button_1_title_value !== (button_1_title_value = /*$buttonText*/ ctx[7].prev)
            ) {
                attr(button_1, "title", button_1_title_value);
            }
...
function create_if_block$1(ctx) {
    ...
    return {
        ...
        p(ctx, dirty) {
            ...
            if (setContent_action && is_function(setContent_action.update) && dirty[0] & /*$_viewTitle*/ 64)
...
function instance$3($$self, $$props, $$invalidate) {
    ...
    $$self.$$.update = () => {
        if (
            $$self.$$.dirty[0] & /*$validRange, $date, $duration, $hiddenDays, $_currentRange, todayDisabled*/ 251658246
        ) {
            if (!isRunning()) {
                running = true;
...
function create_if_block(ctx) {
    ...
    return {
        ...
        p(ctx, dirty) {
            ...
            if (
                !current ||
                (dirty & /*$theme*/ 2 && div_class_value !== (div_class_value = /*$theme*/ ctx[1].buttonGroup))
            ) {
...
function create_each_block$1(ctx) {
    ...
    return {
        ...
        p(ctx, dirty) {
            ...
            if (
                !current ||
                (dirty & /*sections*/ 1 && div_class_value !== (div_class_value = "ec-" + /*key*/ ctx[5]))
            ) {
                attr(div, "class", div_class_value);
            }
        },
...
function create_fragment$2(ctx) {
    ...
    return {
        ...
        p(ctx, [dirty]) {
            ...
            if (
                !current ||
                (dirty & /*$theme*/ 2 && nav_class_value !== (nav_class_value = /*$theme*/ ctx[1].toolbar))
            ) {
    ...
    return {
            ...
            attr(
                ...
                (div_class_value =
                    ...
                    /*$theme*/ (ctx[1].calendar +
                        " " +
                        /*$theme*/ ctx[1].view +
                        /*$_scrollable*/ (ctx[0] ? " " + /*$theme*/ ctx[1].withScroll : "") +
                        /*$_iClass*/ (ctx[2] ? " " + /*$theme*/ ctx[1][/*$_iClass*/ ctx[2]] : ""))),
            );
        ...
        p(ctx, dirty) {
            ...
            if (
                !current ||
                (dirty[0] & /*$view*/ 16 &&
                    div_role_value !== (div_role_value = listView(/*$view*/ ctx[4]) ? "list" : "table"))
            ) {

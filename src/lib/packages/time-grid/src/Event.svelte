<script lang="ts">
    ...
    $effect.pre(() => {
        ...
        let bgColor =
            event.backgroundColor || resourceBackgroundColor(event, $resources) || $eventBackgroundColor || $eventColor;
...
>
    <SvelteComponent start {event} on:pointerdown={createDragHandler($_interaction, ["y", "start"])} />
    <div class={$theme.eventBody} use:setContent={content}></div>
    <SvelteComponent {event} on:pointerdown={createDragHandler($_interaction, ["y", "end"])} />
</article>

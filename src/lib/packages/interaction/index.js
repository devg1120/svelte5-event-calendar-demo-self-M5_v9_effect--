            ...
            if (!mounted) {
                dispose = [
                    ...
                    listen(window_1, "contextmenu", function () {
                        if (is_function(createPreventDefaultHandler(/*contextmenu_handler*/ ctx[44])))
                            createPreventDefaultHandler(/*contextmenu_handler*/ ctx[44]).apply(this, arguments);
                    }),
    ...
    function handlePointerUp(jsEvent) {
        ...
        if (action && jsEvent.isPrimary) {
            ...
            action =
                ...
                extraDuration =
                allDay =
                    set_store_value(_iClass, ($_iClass = minResize = selectStep = margin = undefined), $_iClass);
    ...
    return {
        c() {
            ...
            attr(
                ...
                "class",
                (div_class_value =
                    "" + /*$theme*/ (ctx[2].resizer + /*start*/ (ctx[0] ? " " + /*$theme*/ ctx[2].start : ""))),
            );
        },
        m(target, anchor) {
